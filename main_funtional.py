...
from customdataset import CustomizeData, Ogbdataset, get_random_ids
from gnn import GNN
from loss import ncodLoss
from Visulaize import visualization, makeImagedir, plot_grad_flow
...
parser.add_argument('--gnn',              type=str,   default='gat_actual',     help='the type of the network needed , (default is GCN)')
...
parser.add_argument('--lr_u',             type=float, default=0.1,         help='the learning of the extra parameter')
