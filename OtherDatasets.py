...
parser.add_argument('--gnn',              type=str,   default='gin_newTest',        help='the type of the network needed , (default is GCN)')
...
parser.add_argument('--num_layer',        type=int,   default=4,                    help='number of GNN message passing layers (default: 3),ogb=5,keep 6 for IMBD-Binary')
parser.add_argument('--emb_dim',          type=int,   default=300,                  help='dimensionality of hidden units in GNNs (default: 300)')
parser.add_argument('--batch_size',       type=int,   default=256,                   help='input batch size for training (default: 32),for GNN ogb = 128')
...
parser.add_argument('--class2vis',        type=int,   default=2,                    help='number of classes you want to visualize for now max is 4')
...
parser.add_argument('--aggrNode',         type=str,   default="sum",                help='the learning of the extra parameter')
